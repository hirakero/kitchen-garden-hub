...
export const spotTypeLabel = { ground: '地植え', planter: 'プランター' } as const
  ...
  >
    <div class="card-body p-4">
      <div class="flex items-center justify-between gap-2">
        ...
        <span class="text-xs text-base-content/50 bg-base-200 rounded px-2 py-0.5">{spotTypeLabel[type]}</span>
      </div>
...
export const SpotList: FC<SpotListProps> = ({ spots }) => (
