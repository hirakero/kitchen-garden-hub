...
export const SpotDetailPage: FC<SpotDetailProps> = ({
  ...
  <div class="space-y-6">
    ...
    <section>
      ...
      <div class="space-y-3">
        <PlantingCard id={1} vegetableName="ミニトマト1号鉢" spotName={name} stageName="生育・着果" nextTask="水やり (今日)" />
        <PlantingCard id={2} vegetableName="ミニトマト2号鉢" spotName={name} stageName="定植" nextTask="支柱立て (昨日)" />
      </div>
    </section>
  </div>
)
